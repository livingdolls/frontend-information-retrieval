import { Box, Divider, Paper, Typography, TableBody, TableCell, TableRow } from "@mui/material";
...
const jurnalDetail = (props) => {
    ...
    return (
        <Layout judulmenu={data.title}>
            <Box  display={'flex'} flexDirection={'column'} gap={3} sx={{backgroundColor:"#fff", padding:1}}>
                <Paper elevation={3} sx={{width:'70%',p:5}}>
                    <Typography 
                        variant={'button'}>{data.pengarang}
                    </Typography>
